...
public class CirculoComprimentoActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_circulo_comprimento);
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(valor1.getText().toString().equals("")){
                    Toast.makeText(CirculoComprimentoActivity.this, "Por favor, insira o valor do raio", Toast.LENGTH_LONG).show();
                } else{
                    calculaComprimento();
                }
